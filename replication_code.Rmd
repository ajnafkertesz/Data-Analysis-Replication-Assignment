...
The association of cultural tightness and logged cases per million (Oct 2020) *the scatterplot doesn't inlcude any covariates


```{r cor 1, echo=FALSE, message=FALSE, warning=FALSE}

#run corrolation test for tightness and cases without any controls
cor.test(data$ZTightness,data$OCTCases) #p=-0.406

figure1<-ggplot(data, aes(x = Tightness, y = OCTCases))+
  geom_point(colour = "red", size=1) + 
  geom_text(hjust=0.005, nudge_x = 0.005, label=data$Country, size=2)+
